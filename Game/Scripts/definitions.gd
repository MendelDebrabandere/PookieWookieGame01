...
const tower_projectile_hit_fx: Array[String] = ["res://Resources/Gradients/FireHitParticleGradient.tres", "res://Resources/Gradients/IceHitParticleGradient.tres", "res://Resources/Gradients/PoisonHitParticleGradient.tres"]
